...
import { Quote, ChevronLeft, ChevronRight, Send, AlertCircle, CheckCircle2 } from "lucide-react";
        ...
        >
          ...
          <div className="flex flex-col items-center gap-3 pt-1">
            <button
              ...
              className="flex items-center gap-2 px-5 py-2.5 bg-neutral-900 text-white text-sm rounded-lg hover:bg-neutral-700 transition-colors disabled:opacity-50"
            >
              <Send size={14} />
